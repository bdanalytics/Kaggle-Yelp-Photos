...
title: "Kaggle:Yelp:Restaurant Features: labels classification:: YelpRest_tmplt"
author: "bdanalytics"
...
Data: 
Source: 
    Training:   https://www.kaggle.com/c/yelp-restaurant-photo-classification/download/train.csv.tgz  
...
setwd("~/Documents/Work/DataScience/Kaggle/YelpPhotos")
...
glb_rsp_var <- glb_rsp_var_raw # or "labels.fctr"
...
glbOut <- list(pfx = "YelpRest_tmplt_")
...
#load("YelpRest_tmplt_extract.features.end.RData", verbose = TRUE)
...
for (feat in c("lunch","dinner","reserve","outdoor",
               "expensive","liquor","table","classy",
               "kids")) {
...
#stop("here"); savobsout_df <- obsout_df; all.equal(savobsout_df, obsout_df)
